...
class DocentesmateriasreprobadasComponent extends Component
{
    ...
    public function render()
    {
        ...
        if($this->curso!='|')
         ...
         $query="SELECT  alu_alumno.noexpediente,CONCAT(alu_alumno.apellidos, ' ', alu_alumno.nombre) AS alumno,
            ...
            esc_curso.grupo_id in(".$this->grupos.")   AND  CASE WHEN calif = '' OR calif IS null THEN CASE WHEN calificacion < 60 THEN 1 ELSE 0 END WHEN calif <> 'AC'THEN 1 ELSE 0 END=1 ORDER BY
                concat(emp_perfil.apellido1,' ',emp_perfil.apellido2,' ',emp_perfil.nombre),asi_asignatura.clave,esc_grupo.nombre,cat_turno.nombre, CONCAT(alu_alumno.apellidos, ' ', alu_alumno.nombre) ";
        ...
        return view('livewire.reportes.docentesmateriasreprobadas-component',compact('datos' ,'cicloesc', 'plantelnom', 'titulo'));
