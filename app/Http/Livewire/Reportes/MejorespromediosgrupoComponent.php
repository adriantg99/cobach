...
class MejorespromediosgrupoComponent extends Component
{
    ...
    if ($this->periodo=='P3')
    {
        ...
        $titulo='PARCIAL 3';
         ...
         $datos=collect($dat)->sortBy([['grupo','asc'],['turno','asc'],['cursadas','desc'],['promedio','desc'],['aprobadas','desc'],['alumno','asc']]);
      ...
      /*dd($cicloesc->id.'-'.$plantel_sel->id.'-'."'".$this->grupos."'".'-'."'".$curso."'".'-'.$docente);*/
        ...
        return view('livewire.reportes.mejorespromediosgrupo-component',compact('datos' ,'cicloesc', 'plantelnom', 'titulo'));
