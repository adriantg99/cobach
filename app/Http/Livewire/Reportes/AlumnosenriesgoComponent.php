...
use App\Exports\Reportes\ParcialesreprobadosExport;
...
class AlumnosenriesgoComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.reportes.alumnosenriesgo-component');
    }
    ...
    public function generar_xls()
    {
        ...
        return Excel::download(new ParcialesreprobadosExport($this->plantel_seleccionado, $strgr, $this->docente_seleccionado, $this->curso_seleccionado), $plantel_sel->nombre . 'materias_reprobadas.xlsx');
