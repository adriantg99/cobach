...
use App\Exports\Reportes\IndicadordesercionExport;
use Excel;
...
class IndicadordesercionComponent extends Component
{
...
*/
        return view('livewire.reportes.indicadordesercion-component');
    }
    ...
    public function generar_excel(){
        ...
        //dd(Auth::user()->roles->pluck('name'));
            $ciclo_seleccionado = CicloEscModel::find($this->ciclo_seleccionado);
             ...
             return Excel::download(new IndicadordesercionExport ($this->ciclo_seleccionado), $ciclo_seleccionado->nombre.'indicadesercion.xlsx');
