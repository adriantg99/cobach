...
use App\Exports\Reportes\IngresosExport;
use Excel;
...
class IngresosComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.reportes.ingresos-component');
    }
...
/*
        //dd(Auth::user()->roles->pluck('name'));
            $ciclo_seleccionado = CicloEscModel::find($this->ciclo_seleccionado);
             ...
             return Excel::download(new IngresosExport ($this->ciclo_seleccionado), $ciclo_seleccionado->nombre.'ingresos.xlsx');
