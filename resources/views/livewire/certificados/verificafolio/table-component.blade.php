                            ...
                            <div class="card-body">
                                <h5>Especifica:</h5>
                                 <div class="col-6 col-sm-6">
                                    ...
                                    <input class="form-control" placeholder="Curp" readonly name="curp" wire:model="curp" type="text">
                                    <label class="form-label">Folio:</label>
                                    <input class="form-control" placeholder="Folio" readonly name="folio" wire:model="folio" type="text">
