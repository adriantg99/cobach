            ...
            <table cellspacing="0" cellpadding="0" style="width:100%; ">
                ...
                {{-- <table  class="table  table-condensed  table-striped text-center" > --}}
                    <table cellspacing="0" cellpadding="0" style="width:100%; margin: 55mm 0mm 0mm 0mm; ">
                        ...
                        <tr>
                            <td  style=" font-size:18px;  " ><strong>{{$datos['puesto']}} de la {{$datos['entidad']}}</strong></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td  style=" font-size:16px; text-align:justify  " >En atención a su @php if($datos['numoficio']=='') echo'correo electrónico'; else echo'oficio '.$datos['numoficio']; @endphp
                                @if (count($detalle)>1)
                                , en el cual solicita verificar la autenticidad del certificado de terminación de estudios a nombre de los jóvenes que se enlistan a continuación, le informo que los documentos en cuestión son <strong>APÓCRIFOS.</string>
                                @else
                                , en el cual solicita verificar la autenticidad del certificado de terminación de estudios a nombre de {{$detalle[0]['el_la']}} joven <strong>{{$detalle[0]['nombrealumno']}}</strong>, le informo que el documento en cuestión es <strong>ES APÓCRIFO.</string>
                                @endif
                                </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td  style=" font-size:16px; text-align:justify  " >Lo anterior,
                                en virtud de que los datos asentados en el documento presentado por
                                @if(count($detalle)>1)
                                los jóvenes
                                @else
                                {{$detalle[0]['el_la']}} joven {{$detalle[0]['nombrealumno']}}
                                @endif
                                , no
                                existen en nuestros registros físicos ni electrónicos que se encuentran bajo resguardo del Departamento de
