...
@section('encabezadodet')
    ...
    <table cellspacing="0" cellpadding="0" style="width:100%; margin: 2mm 0mm 0mm 0mm; font-size:10px; ">
       <thead>
            <tr>
                <th colspan="3" style="border: 1pt solid gray; background-color: gray; text-align: left;">DOCENTE</th>
    ...
    <section>
           <table style="width:100%; border-spacing:0">
               ...
               foreach ($datos as $det)
               {
                   ...
                   @endphp
                   <tr>
                       <td colspan="9" style="border: 1pt solid gray; background-color: gray;">{{$det->expediente}} {{$det->docente}}</td>
                   </tr>
                   @php
                   }
                   if($clave!=$det->clave)
