<div>
    ...
    <div class="card shadow" id="principal">
        <div class="card-header py-3">
            <p class="text-primary m-0 fw-bold">Alumnos en riesgo de reprobación</p>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row mt-3">
                <div class="col-12">
                          <button wire:click="generar_xls" wire:loading.attr="disabled" wire:loading.class="bg-secondary"
                        wire:loading.remove class="btn btn-primary float-end">Exportar a Excel</button>
                    <span wire:loading wire:target="generar_xls">Descargando...</span>
                   ...
                   <div class="col-md-12">
                        ...
                        <button onclick="reportesriesgo(); " wire:loading.attr="disabled" wire:loading.class="bg-secondary"
...
function generandoriesgoalu() {

let url = "{{ route('reporte.paralumnosmateriasreprobadas',array(":plantel",":grupos",":periodo",":docente",":curso")) }}";
...
function generandoriesgo() {

let url = "{{ route('reporte.parmateriasreprobadas',array(":plantel",":grupos",":periodo",":docente",":curso")) }}";
...
function generandoriesgodoc() {


let url = "{{ route('reporte.pardocentesmateriasreprobadas',array(":plantel",":grupos",":periodo",":docente",":curso")) }}";
