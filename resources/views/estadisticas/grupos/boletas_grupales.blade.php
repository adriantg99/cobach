...
@endphp
@foreach ($alumnos_en_plantel_periodo as $alumno_periodo)
    @php
        
        $datos_alumno = AlumnoModel::find($alumno_periodo->alumno_id);
        /*
        if (count($datos_alumno->cursos_del_grupo($alumno_periodo->grupo_id, $datos_alumno->alumno_id)) < 3) {
...
*/
        ...
        $datos_grupo_plantel_alumno = CursosModel::join('esc_grupo', 'esc_curso.grupo_id', '=', 'esc_grupo.id')
            ...
            ->where('esc_grupo_alumno.alumno_id', $alumno)
                                        ...
                                        <td
                                            ...
                                            @php
                                                ...
                                                if ($calificacion->parcial3 != null) {
                                                    if (
                                                        $calificacion->calificacion_final != null &&
                                                        ($calificacion->calificacion_final != 'AC' &&
                                                            $calificacion->calificacion_final != 'NA')
                                                    ) {
                                                        if ($calificacion->calificacion_r != null) {
                                                            echo round($calificacion->calificacion_r);
                                                        } else {
                                                            echo round($calificacion->calificacion_final);
                                                        }
                                                    } else {
                                                        echo $calificacion->calificacion_final;
                                                    }
