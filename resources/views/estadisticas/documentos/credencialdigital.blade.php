...
@if (isset($imagen_alumnos))
        ...
        <div class="imagen-container">
            ...
            <div class="texto-encima">
                ...
                <table style="">
                    <tr>
                        <td></td>
                        <td align="center" style="font-weight: bold; font-size: 16px;  width: 100px; text-align: center;">
                            ALUMNO:</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td align="center" style="font-weight: bold; font-size: 14px;">{{ $dato->nombre }}</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td align="center"
                            style="font-weight: bold; font-size: 14px;  width: 100px; text-align: center;">
                            {{ $dato->apellidos }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td align="center"
                            style="font-weight: bold; font-size: 16px; text-align:center;  width: 100px; text-align: center;">
                            EXPEDIENTE:</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td align="center" style="  font-size: 16px; ">{{ $dato->noexpediente }}</td>
                    </tr>
                    <tr>
                        <td style="color: white;">.</td>
                    </tr>
                    ...
                    <tr>
                        <td></td>
                        <td align="center"
                            style="font-weight: bold; font-size: 16px; width: 100px; text-align: center;">PLANTEL:</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td align="left" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align: center;  font-size: 14px;">
                            {{ $dato->plantel }}</td>
                    </tr>
                </table>
            ...
            <div class="codigo-qr">
                <img src="data:image/png;base64,{{$codigoqr}}" alt="qrcode"  height="80"  >
        ...
        onclick="window.location='{{route('alumno.credencial')}}';"
      >Generar PDF</button>
      @else
      <div>
